"""
Django settings for taylor_test_app_3 project.
...
ROOT_URLCONF = 'taylor_test_app_3.urls'
...
WSGI_APPLICATION = 'taylor_test_app_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taylor_test_app_3 API",
    "DESCRIPTION": "API documentation for taylor_test_app_3 App",
    "VERSION": "v1",
}
